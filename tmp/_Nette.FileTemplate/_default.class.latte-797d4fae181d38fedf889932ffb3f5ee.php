...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf7033f57a5_content')) { function _lbf7033f57a5_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb2d445722e6_children')) { function _lb2d445722e6_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb8f23da0ae7_method')) { function _lb8f23da0ae7_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb500cb5bd79_property')) { function _lb500cb5bd79_property($_l, $_args) { extract($_args)
